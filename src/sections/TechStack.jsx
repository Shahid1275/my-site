            ...
            {technologies.slice(0, 5).map((tech, index) => (
              <div key={index} className="group flex flex-col items-center">
                <div
                  ...
                  transition-all duration-300 ease-in-out
                  group-hover:scale-105 group-hover:shadow-lg group-hover:shadow-${
                    tech.color.split("text-")[1].split("]")[0]
                  }/30
                  group-hover:bg-${
                    tech.color.split("text-")[1].split("]")[0]
                ...
                >
                  <tech.Icon
                    className={`${tech.color} text-3xl sm:text-4xl fill-current transition-transform duration-300 ease-in-out group-hover:scale-110`}
                  />
                </div>
                <span className="mt-4 text-sm sm:text-base font-semibold text-white group-hover:text-${tech.color.split('text-')[1].split(']')[0]} transition-colors duration-300 relative">
                  {tech.name}
                  <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-${tech.color.split('text-')[1].split(']')[0]} transition-all duration-300 group-hover:w-full" />
                </span>
              </div>
            ))}
          </div>
